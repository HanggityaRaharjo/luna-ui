  ...
  return (
    <LayoutContent>
      ...
      <div className=" relative border-b-2 border-gray-200 mb-4 py-2 group ">
        ...
        <h2 className="text-[30px] font-bold ">Footer</h2>
      </div>
      {/* End Title */}
      ...
      <section className="mb-4">
        ...
        <ViewComponent>
          <footer className="footer p-10 bg-neutral text-white w-full">
            <nav>
        ...
        <CodeSnippet
          type="html"
          code={`<footer className="footer p-10 bg-neutral text-white ">
    <nav>
      <header className="footer-title">Services</header>
      <a href="...">Branding</a>
      <a href="...">Design</a>
...
`}
      ...
      <section className="mb-4">
        ...
        <CodeSnippet
          type="html"
          code={`<footer className="footer p-10 ">
  <aside>
